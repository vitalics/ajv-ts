...
test('InferInput/InferOutput matches library inference', () => {
  ...
  assertType<StandardSchemaV1.InferOutput<typeof schema>>({} as InferOutputType<typeof schema>)
  assertType<InferOutputType<typeof schema>>({} as StandardSchemaV1.InferOutput<typeof schema>)
  assertType<StandardSchemaV1.InferInput<typeof schema>>({} as InferOutputType<typeof schema>)
})
